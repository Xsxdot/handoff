...
| pages/settings.html | 设置页（开发机/执行纪律/**自动化**/常规/Env/更新；`?section=automation` 直达编制卡） | `/settings` | 自动化分区主体已确认（2026-08-28 B282 回流）。**载体四态 / 检测 / 运行 / 默认 HOME** 确认中（2026-08-29 B293，形态权威 `prototypes/b293-carrier-home/`） |
