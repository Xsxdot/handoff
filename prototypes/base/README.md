...
| （未建页） | 代码图页（领域图三级下钻：领域全景卡+调用连线 → 嵌套子领域全景（域外虚线占位卡横跳）→ 叶子领域树+图（左树 320px + 竖向焦点子图 + 右详情 340px）；面包屑逐级返回） | 规划中（spec `docs/superpowers/specs/2026-08-19-codegraph-design.md`） | 确认中 |
