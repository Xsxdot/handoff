...
const tickets: GlobalTickets = { items: [item], count: 1, byWorkDir: new Map([['/w/b2-b3', 1]]), refresh: vi.fn() }
...
describe('TicketsOverlay', () => {
  ...
  it('一张工单都没有时给出明确空态，不是空白', () => {
    render(<TicketsOverlay tickets={{ items: [], count: 0, byWorkDir: new Map(), refresh: vi.fn() }} onOpenTask={vi.fn()} onClose={vi.fn()} />)
