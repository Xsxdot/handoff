...
func TestResourceContractsCarryStableIdentityAndVersions(t *testing.T) {
	...
	values := []struct {
		...
		{"git status", GitStatusSnapshot{WorkspaceID: "ws1", IsRepository: true, Branch: "main", HeadOID: "abc", Entries: []GitStatusEntry{{Path: "README.md", WorktreeStatus: "M"}}}, []string{`"is_repository":true`, `"head_oid":"abc"`, `"worktree_status":"M"`}},
