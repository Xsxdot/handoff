...
func (a *Adapter) Name() string { return executor.HarnessGrok }
...
func (a *Adapter) Report() executor.CapabilityReport {
	...
	if err != nil {
		if a != nil && a.log != nil {
			a.log.Error("BaselineReport 失败，返回空能力报告", "harness", executor.HarnessGrok, "cause", err)
		}
		return executor.CapabilityReport{Harness: executor.HarnessGrok}
	}
	return rep
}
